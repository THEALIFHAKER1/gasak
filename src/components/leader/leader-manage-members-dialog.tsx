...
interface LeaderManageMembersDialogProps {
  children: React.ReactNode;
  squad: Squad;
  onMembersUpdated: () => void;
}

export function LeaderManageMembersDialog({
  children,
  squad,
  onMembersUpdated,
}: LeaderManageMembersDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add or remove members from your squad: {squad.name}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            {availableUsers.length === 0 && (
              <p className="text-muted-foreground text-sm">
                No available members to add. All members may already be assigned
                to squads.
              </p>
            )}
          </div>
